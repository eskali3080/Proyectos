            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <article>
                        ...
                        <header class="mb-4">
                            <!-- Post title-->
                            <h1 class="fw-bolder mb-1">Acerca del cultivo del arroz</h1>
                            <!-- Post meta content-->
                            <div class="text-muted fst-italic mb-2">Publicado el 1 de marzo de 2024, por Search with Agro</div>
                            <!-- Post categories-->
                    ...
                    <section>
                        <h2 class="fw-bolder mb-4 mt-5">Variedades de Arroz Cultivadas en la Región de Cúcuta, Norte de Santander</h2>
                        <section>
                                ...
                                <table class="table table-bordered custom-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <ul>
                                                    <li>Tamaño del grano: Medio a largo.</li>
                                                    <li>Ciclo de crecimiento: Moderadamente corto.</li>
                                                    <li>Resistencia a enfermedades: Buena resistencia a algunas enfermedades comunes del arroz, como la piriculariosis y la bacteriosis.</li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Variedad "Fedearroz 60"</td>
                                            <td>
                                                <ul>
                                                    <li>Tamaño del grano: Medio.</li>
                                                    <li>Ciclo de crecimiento: Corto a medio.</li>
                                                    <li>Resistencia a enfermedades: Alta resistencia a enfermedades como la bacteriosis y el tizón bacteriano del arroz.</li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Variedad "Fedearroz 50"</td>
                                            <td>
                                                <ul>
                                                    <li>Tamaño del grano: Medio a largo.</li>
                                                    <li>Ciclo de crecimiento: Medio a largo.</li>
                                                    <li>Resistencia a enfermedades: Buena resistencia a enfermedades comunes del arroz, como la bacteriosis y el tizón bacteriano.</li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Variedad "Fedearroz 73"</td>
                                            <td>
                                                <ul>
                                                    <li>Tamaño del grano: Largo.</li>
                                                    <li>Ciclo de crecimiento: Medio a largo.</li>
                                                    <li>Resistencia a enfermedades: Buena resistencia a enfermedades comunes del arroz, como la piriculariosis y el tizón bacteriano.</li>
                                                </ul>
                                            </td>
                                        </tr>
                                    </tbody>
...
<section>
    ...
    <p class="fs-5 mb-4">Capacitación y asistencia técnica: Brindar capacitación y asistencia técnica a los agricultores sobre prácticas agronómicas adecuadas, manejo integrado de plagas y enfermedades, y uso eficiente de recursos como agua y fertilizantes. Esto ayudará a mejorar las habilidades y conocimientos de los agricultores, permitiéndoles tomar decisiones informadas para aumentar la productividad y la rentabilidad de sus cultivos.</p>
                ...
                <div class="col-lg-4">
                    ...
                    <!-- Categories widget-->
                    <div class="card mb-4">
                        <div class="card-header">Tambien te puede interesar</div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                    ...
                    <!-- Side widget-->
                    <div class="card mb-4">
                        <div class="card-header">Recurda</div>
                        <div class="card-body">"En cada semilla de arroz yace el potencial de un campo dorado, donde la perseverancia florece y la cosecha es la recompensa de un trabajo bien hecho."
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Search with Agro 2024 </p></div>
        </footer>
        <!-- Bootstrap core JS-->
